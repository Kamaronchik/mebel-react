...
const Section = () => {
    return (
        <div className="flex flex-col w-full">
            ...
            <div className="bg-[#f3f3f3] px-12 py-16">
                <div className="flex flex-col lg:flex-row items-center gap-14 max-w-7xl mx-auto">
                    ...
                    <div className="max-w-xl">
                        <h2 className="text-4xl font-light text-black mb-8 leading-snug">
            ...
            <div
                className="relative flex items-center justify-between px-12 py-16 overflow-hidden"
                style={{ background: 'linear-gradient(135deg, #f97316 0%, #a855f7 100%)' }}
            >
                <div className="z-10">
                    <h2 className="text-black text-4xl font-bold leading-tight mb-3">
                        Не нашли того,<br />что искали?
                    </h2>

                    <p className="text-black text-sm mb-6">
                        Оставьте свой номер и мы подберем для Вас всё, что нужно
                    </p>
                    ...
                    <div className="flex gap-3">
                        <input
                            type="text"
                            placeholder="Телефон"
                            className="input input-sm bg-white/20 border-black text-black placeholder-black/60 w-48"
                        />
                        <button className="btn btn-sm bg-white text-black border-black font-bold">
                            ОТПРАВИТЬ
                        </button>
                    </div>
                </div>
                ...
                <img
                    src={sofa}
                    alt="sofa"
                    className="absolute right-12 bottom-0 h-64 object-contain"
                />
            </div>

            <div className="bg-white py-10 px-8">
                <h2 className="text-center text-2xl font-bold tracking-widest mb-8 text-black">
                    ОТЗЫВЫ
                </h2>
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    <div className="border rounded-xl p-4 flex-1 min-w-64">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-sm font-semibold ml-1 text-black">Юсуф</span>
                        </div>

                        <p className="text-xs text-black mb-1">Комментарий:</p>
                    ...
                    <div className="border rounded-xl p-4 flex-1 min-w-64">
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-sm font-semibold ml-1 text-black">
                                Антон Парзунев
                            </span>
                        </div>
